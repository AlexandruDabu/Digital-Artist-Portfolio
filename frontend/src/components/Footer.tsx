...
function Copyright() {
  return (
    <Typography variant="body2" color="text.secondary" mt={1}>
      {'Copyright © '}
      <Link target="_blank" href="https://portofolio-alexandru.fly.dev/">Alexandru Dabuleanu Felix&nbsp;</Link>
    ...
    >
      ...
      >
        ...
        >
          <IconButton
            color="inherit"
            href="https://github.com/AlexandruDabu"
            target="_blank"
            aria-label="GitHub"
            sx={{ alignSelf: 'center' }}
          >
          ...
          <IconButton
            color="inherit"
            href="https://www.instagram.com/felix_alexandru1/"
            target="_blank"
          ...
          <IconButton
            color="inherit"
            target="_blank"
            href="https://www.linkedin.com/in/alexandru-dabuleanu-b47065226/"
            aria-label="LinkedIn"
            sx={{ alignSelf: 'center' }}
          >
            <LinkedInIcon />
